...
int _speciesEstimateSize(
  ...
  bytesCount += 3 + object.kingdom.length * 3;
...
void _speciesSerialize(
  ...
  writer.writeString(offsets[2], object.family);
  writer.writeBool(offsets[3], object.isCaught);
  writer.writeString(offsets[4], object.kingdom);
...
Species _speciesDeserialize(
  ...
  object.family = reader.readString(offsets[2]);
  object.id = id;
  object.isCaught = reader.readBool(offsets[3]);
  object.kingdom = reader.readString(offsets[4]);
...
extension SpeciesQueryFilter
  ...
  QueryBuilder<Species, Species, QAfterFilterCondition> familyEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Species, Species, QAfterFilterCondition> familyGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Species, Species, QAfterFilterCondition> familyLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Species, Species, QAfterFilterCondition> familyBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Species, Species, QAfterFilterCondition> familyStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Species, Species, QAfterFilterCondition> familyEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Species, Species, QAfterFilterCondition> familyContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<Species, Species, QAfterFilterCondition> familyMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<Species, Species, QAfterFilterCondition> familyIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'family',
        value: '',
  ...
  QueryBuilder<Species, Species, QAfterFilterCondition> familyIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'family',
        value: '',
  ...
  QueryBuilder<Species, Species, QAfterFilterCondition> kingdomEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Species, Species, QAfterFilterCondition> kingdomGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Species, Species, QAfterFilterCondition> kingdomLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Species, Species, QAfterFilterCondition> kingdomBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Species, Species, QAfterFilterCondition> kingdomStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Species, Species, QAfterFilterCondition> kingdomEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Species, Species, QAfterFilterCondition> kingdomContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<Species, Species, QAfterFilterCondition> kingdomMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<Species, Species, QAfterFilterCondition> kingdomIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'kingdom',
        value: '',
  ...
  QueryBuilder<Species, Species, QAfterFilterCondition> kingdomIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'kingdom',
        value: '',
...
extension SpeciesQuerySortBy on QueryBuilder<Species, Species, QSortBy> {
  ...
  QueryBuilder<Species, Species, QAfterSortBy> sortByFamily() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'family', Sort.asc);
    });
  }

  QueryBuilder<Species, Species, QAfterSortBy> sortByFamilyDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Species, Species, QAfterSortBy> sortByKingdom() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'kingdom', Sort.asc);
    });
  }

  QueryBuilder<Species, Species, QAfterSortBy> sortByKingdomDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'kingdom', Sort.desc);
    });
  }
...
extension SpeciesQuerySortThenBy
  ...
  QueryBuilder<Species, Species, QAfterSortBy> thenByFamily() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'family', Sort.asc);
    });
  }

  QueryBuilder<Species, Species, QAfterSortBy> thenByFamilyDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'family', Sort.desc);
    });
  }
  ...
  QueryBuilder<Species, Species, QAfterSortBy> thenByKingdom() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'kingdom', Sort.asc);
    });
  }

  QueryBuilder<Species, Species, QAfterSortBy> thenByKingdomDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'kingdom', Sort.desc);
    });
  }
...
extension SpeciesQueryWhereDistinct
  ...
  QueryBuilder<Species, Species, QDistinct> distinctByFamily(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Species, Species, QDistinct> distinctByKingdom(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'kingdom', caseSensitive: caseSensitive);
    });
  }
...
extension SpeciesQueryProperty
  ...
  QueryBuilder<Species, String, QQueryOperations> familyProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Species, String, QQueryOperations> kingdomProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'kingdom');
    });
  }
